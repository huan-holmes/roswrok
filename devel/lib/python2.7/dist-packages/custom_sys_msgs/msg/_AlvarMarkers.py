...
"""autogenerated by genpy from custom_sys_msgs/AlvarMarkers.msg. Do not edit."""
import sys
...
class AlvarMarkers(genpy.Message):
  _md5sum = "482f7d740dba8f6b77df1734db153e78"
  _type = "custom_sys_msgs/AlvarMarkers"
...
float64 w
"""
  __slots__ = ['header','rt','makers']
  _slot_types = ['std_msgs/Header','bool','custom_sys_msgs/AlvarMarker[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.rt))
      length = len(self.makers)
      buff.write(_struct_I.pack(length))
      for val1 in self.makers:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.rt,) = _get_struct_B().unpack(str[start:end])
      self.rt = bool(self.rt)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.makers = []
      for i in range(0, length):
        val1 = custom_sys_msgs.msg.AlvarMarker()
        _v9 = val1.header
        start = end
        end += 4
