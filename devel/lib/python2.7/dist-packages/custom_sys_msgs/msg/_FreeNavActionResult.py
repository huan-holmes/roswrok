...
"""autogenerated by genpy from custom_sys_msgs/FreeNavActionResult.msg. Do not edit."""
import sys
...
class FreeNavActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "custom_sys_msgs/FreeNavActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','custom_sys_msgs/FreeNavResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FreeNavActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = custom_sys_msgs.msg.FreeNavResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = custom_sys_msgs.msg.FreeNavResult()
