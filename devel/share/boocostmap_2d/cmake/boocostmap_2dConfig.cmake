...
if(boocostmap_2d_CONFIG_INCLUDED)
  return()
endif()
set(boocostmap_2d_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(boocostmap_2d_SOURCE_PREFIX /home/boocax/roswork/src/boocostmap_2d)
  set(boocostmap_2d_DEVEL_PREFIX /home/boocax/roswork/devel)
  set(boocostmap_2d_INSTALL_PREFIX "")
  set(boocostmap_2d_PREFIX ${boocostmap_2d_DEVEL_PREFIX})
else()
  set(boocostmap_2d_SOURCE_PREFIX "")
  set(boocostmap_2d_DEVEL_PREFIX "")
  set(boocostmap_2d_INSTALL_PREFIX /home/boocax/roswork/install)
  set(boocostmap_2d_PREFIX ${boocostmap_2d_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'boocostmap_2d' is deprecated")
...
set(boocostmap_2d_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/boocax/roswork/src/boocostmap_2d/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/tcl;/usr/include/libxml2 " STREQUAL " ")
  set(boocostmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/roswork/src/boocostmap_2d/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/tcl;/usr/include/libxml2")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(boocostmap_2d_LIBRARY_DIRS ${lib_path})
      list(APPEND boocostmap_2d_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'boocostmap_2d'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND boocostmap_2d_LIBRARIES ${lib})
    endif()
  endif()
...
set(boocostmap_2d_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${boocostmap_2d_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;laser_geometry;map_msgs;message_filters;message_runtime;nav_msgs;pcl_ros;roscpp;sensor_msgs;std_msgs;tf;custom_sys_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 boocostmap_2d_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${boocostmap_2d_dep}_FOUND)
      find_package(${boocostmap_2d_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${boocostmap_2d_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(boocostmap_2d_INCLUDE_DIRS ${${boocostmap_2d_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(boocostmap_2d_LIBRARIES ${boocostmap_2d_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${boocostmap_2d_dep}_LIBRARIES})
  _list_append_deduplicate(boocostmap_2d_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(boocostmap_2d_LIBRARIES ${boocostmap_2d_LIBRARIES})

  _list_append_unique(boocostmap_2d_LIBRARY_DIRS ${${boocostmap_2d_dep}_LIBRARY_DIRS})
  list(APPEND boocostmap_2d_EXPORTED_TARGETS ${${boocostmap_2d_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${boocostmap_2d_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
