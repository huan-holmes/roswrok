...
(defsystem "teb_local_planner-msg"
  ...
  :components ((:file "_package")
    (:file "AgvLineMsg" :depends-on ("_package_AgvLineMsg"))
    (:file "_package_AgvLineMsg" :depends-on ("_package"))
    (:file "AgvTrajectoryMsg" :depends-on ("_package_AgvTrajectoryMsg"))
    (:file "_package_AgvTrajectoryMsg" :depends-on ("_package"))
