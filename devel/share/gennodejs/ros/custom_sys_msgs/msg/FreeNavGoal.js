...
class FreeNavGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FreeNav.serialize(obj.path, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FreeNavGoal(null);
    // Deserialize message field [path]
    data.path = FreeNav.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += FreeNav.getMessageSize(object.path);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FreeNavGoal(null);
    if (msg.path !== undefined) {
      resolved.path = FreeNav.Resolve(msg.path)
    }
    else {
      resolved.path = new FreeNav()
    }
