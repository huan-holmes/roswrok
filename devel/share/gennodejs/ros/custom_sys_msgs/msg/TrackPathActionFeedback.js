...
class TrackPathActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TrackPathFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackPathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrackPathActionFeedback(null);
    ...
    data.feedback = TrackPathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrackPathFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackPathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrackPathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrackPathFeedback()
    }
...
module.exports = TrackPathActionFeedback;
