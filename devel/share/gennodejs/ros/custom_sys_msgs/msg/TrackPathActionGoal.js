...
class TrackPathActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackPathGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrackPathGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackPathActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TrackPathGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TrackPathGoal()
    }
...
module.exports = TrackPathActionGoal;
