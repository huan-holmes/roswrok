...
class TrackPathActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new TrackPathResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackPathResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackPathActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = TrackPathResult.Resolve(msg.result)
    }
    else {
      resolved.result = new TrackPathResult()
    }
...
module.exports = TrackPathActionResult;
