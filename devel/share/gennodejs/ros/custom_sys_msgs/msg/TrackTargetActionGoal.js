...
class TrackTargetActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackTargetGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrackTargetGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackTargetActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TrackTargetGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TrackTargetGoal()
    }
...
module.exports = TrackTargetActionGoal;
